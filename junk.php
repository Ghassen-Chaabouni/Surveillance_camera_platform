...
<html>
<head>
    <title>D-Link DCS-942L Surveillance Camera</title>
</head>
...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
  <a class="navbar-brand" href="index.php" id="navbar_title">D-Link</a>
...
if(is_dir($dir_path)){
    ...
    for($i = 2; $i < count($files)+2; $i++){
        ...
        if(in_array($extension, $extensions_array)){
            ...
            echo '<a href="delete_pic2.php?pic='.$dir_path.'/'.$files[$i].'"><button type="submit" name="submit2" class="btn btn-outline-danger" name="delete">Delete</button></a>';
            echo '</div>';
            echo '</div>';
        }
