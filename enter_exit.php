...
<body style="background-color: #eee;">
            ...
            <div class="collapse navbar-collapse navbar-fixed-top" id="navbarText">
                <ul class="navbar-nav mr-auto">
                    ...
                    <li class="nav-item active" id="live_navbar">
                        <?php
                            echo '<a class="nav-link" href="#">Enter/Exit</a>';
                        ?>
                    </li>
    ...
    <div class="content">
        <div id="main" align="center">
            ...
            <br/>
            <?php
                echo '<form action="upload_to_train2.php?id='.$id.'" method="POST" enctype="multipart/form-data">';
            ?>
            ...
            <?php
                echo '<form action="start_training_enter_exit.php?id='.$id.'" method="POST" enctype="multipart/form-data">';
            ?>
                <div class="col-sm-10"><input type="number" name="epoch" min="1" placeholder="Epoch" class="form-control" id="epoch" required></div>
                <div><button id="train" type="submit" name="train" class="btn btn-outline-info">Start training</button></div>
            </form>
                ...
                for($j = 2; $j < count($files)+2; $j++){
                    ...
                    for($i = 2; $i < count($files2)+2; $i++){
                        ...
                        if(in_array($extension, $extensions_array)){
                            ...
                            echo '<a href="delete_pic_train2.php?id='.$id.'&pic='.$path.'/'.$files2[$i].'"><button type="submit" name="submit2" class="btn btn-outline-danger" name="delete">Delete</button></a>';
                            echo '</div>';
                            echo '</div>';
                        }
                    }
